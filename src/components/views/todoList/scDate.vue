...
export default {
    ...
    computed: {
        isShowAdd() {
            return (this.currentTime == this.month)&& (new Date().getTime() <= this.date.getTime()|| new Date().getDate() == this.date.getDate())
        },
